		...
		<form action="${pageContext.request.contextPath}/book/addBook" method="post"
			...
			<table>
				...
				<tr>
					...
					<td>字数：</td>
					<td><input type="number" name="wordNum" class="el-input__inner"></td>
				</tr>
				...
				<tr>
					...
					<td rowspan="2"><textarea class="el-textarea__inner"
							name="editorRecommend"></textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					...
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner"
							name="contentAbstract"></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					<td>印刷时间：</td>
					<td><input type="date" name="printDate"
						class="el-input__inner"></td>
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner"
							name="authorAbstract"></textarea></td>
				</tr>
				<tr>
					<td>印次：</td>
					<td><input type="text" name="impression"
						class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>纸张：</td>
					<td><input type="text" name="paper"
						class="el-input__inner"></td>
					<td>媒体评论：</td>
					<td rowspan="2"><textarea class="el-textarea__inner"
							name="mediaCommentary"></textarea></td>
				</tr>
				<tr>
					<td>包装：</td>
