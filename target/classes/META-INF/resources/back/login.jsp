...
<script type="text/javascript">
	function changeImage(){
		$("#imgVcode").src({"src":"${pageContext.request.contextPath}/security/getSecurity"});
	}
</script>
							...
							<div id="J_captchVcodeWrap" style="" class="Captcha">
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:;" onclick="document.getElementById('code').src = '${pageContext.request.contextPath}/security/getSecurity?'+(new Date()).getTime()">
											<img id="code" src="${pageContext.request.contextPath}/security/getSecurity" class="Ucc_captcha Captcha-image"/>
										</a>
										<a href="javascript:;" onclick="document.getElementById('code').src = '${pageContext.request.contextPath}/security/getSecurity?'+(new Date()).getTime()" class="code_picww">换一张</a>
