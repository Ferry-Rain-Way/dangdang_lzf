...
<html>
  ...
  <body style="text-align: center;background-color: #d4e7f0">  <!-- #f0f9fd -->
   	...
   	<div style="text-align: center" class="div1">
   		<div class="aa">
			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/category/selectAllCategory" target="Homepage">类别管理</a><br/><br/>
		</div>
		<div class="aa">
  			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/book/selectAllBook"  target="Homepage">图书管理</a><br/><br/>
  		</div>
  		<div class="aa">
  			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/order/selectAll"  target="Homepage">订单管理</a><br/><br/>
  		</div>
  		<div class="aa">
  			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/user/selectAllUsers" target="Homepage">用户管理</a><br/><br/>
  		</div>
  	</div>
  </body>
</html>
