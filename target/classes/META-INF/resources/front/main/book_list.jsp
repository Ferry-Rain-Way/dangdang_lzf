...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class='your_position'>
			...
			<c:forEach items="${category.second}" var="second">
							...
							<li>
								<div>
									<div class=second_fenlei>
										<a href="${pageContext.request.contextPath }/book/second?fid=${category.id}&currentPage=1">
								...
								<li>
									<div>
										...
										<div class=second_fenlei3>
											<a href="${pageContext.request.contextPath }/book/second?fid=${category.id}&sid=${second.id}&currentPage=1">
					...
					<div id="book_list" class="list_r_title">
						...
						<div id="divTopPageNavi" class="list_r_title_text3">
							...
							<c:if test="${currentPage > 1}">
								<!-- 首页 -->
								<div class='list_r_title_text3a'>
									<a name=link_page_next href="${pageContext.request.contextPath }/book/second?fid=${category.id }&sid=${sid}&currentPage=1">
										<img src='${pageContext.request.contextPath }/front/images/page_up.gif' /> 
									</a>
								</div>
								<!-- 上一页 -->
								<div class='list_r_title_text3a'>
									<a name=link_page_next href="${pageContext.request.contextPath }/book/second?fid=${category.id }&sid=${sid }&currentPage=${currentPage-1}">
										<img src='${pageContext.request.contextPath }/front/images/page_up.gif' /> 
									</a>
								</div>							
							</c:if>
							...
							<c:if test="${currentPage < totalPage}">
								...
								<!-- 末页 -->
								<div class='list_r_title_text3a'>
									<a name=link_page_next href="${pageContext.request.contextPath }/book/second?fid=${category.id }&sid=${sid }&currentPage=${totalPage}">
										<img src='${pageContext.request.contextPath }/front/images/page_down.gif' /> 
									</a>
								</div>
							</c:if>
