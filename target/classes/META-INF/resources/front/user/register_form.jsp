...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="${pageContext.request.contextPath }/user/register" id="f" onsubmit="return check()">
				<h2>
					以下均为必填项&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					${message}
				</h2>
				<table class="tab_login" >
					<tr>
						...
						<td>
							<input name="email" onblur="checkEmail()" type="text" id="txtEmail" class="text_input"/>
					...
					<tr>
						...
						<td>
							<input name="nickname" onblur="checkNickname()" type="text" id="txtNickName" class="text_input" />
							<script type="text/javascript">
					...
					<tr>
						...
						<td>
							<input name="password" onblur="checkPassword()" type="password" id="txtPassword" class="text_input" />
							<script type="text/javascript">
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="${pageContext.request.contextPath }/security/getSecurity" />
								...
								<p class="t1">
									...
									<script type="text/javascript">
										$("#change").on("click",function(){
											$("#imgVcode").attr("src","${pageContext.request.contextPath }/security/getSecurity?t="+Math.random());
										});
										$("#imgVcode").on("click",function(){
											//$("#imgVcode").attr("src","<s:url value="/user/getCode"/>?t="+Math.random());
											$(this).attr("src","${pageContext.request.contextPath }/security/getSecurity?t="+Math.random());
										});
										function checkCode(){
